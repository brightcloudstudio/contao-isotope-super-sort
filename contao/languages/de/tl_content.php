...
$GLOBALS['TL_LANG']['tl_content']['iso_super_sort_page_link_multipage'] = 'Dieses Element wird über das Layout eingebunden und kann auf mehreren Seiten erscheinen; jede Seite verwendet daher ihre eigene „Produktsortierung“ (bearbeiten unter Seitenstruktur → die Seite → Produktsortierung). Um stattdessen hier eine einzige Reihenfolge festzulegen, setzen Sie die Quelle der Sortierung auf „Reihenfolge an diesem Element festlegen“.';
